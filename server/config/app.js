...
const router_index_1 = __importDefault(require("../routes/router.index"));
const router_movie_1 = __importDefault(require("../routes/router.movie"));
...
app.use('/', router_index_1.default);
app.use('/', router_movie_1.default);
app.use('/', router_auth_1.default);
