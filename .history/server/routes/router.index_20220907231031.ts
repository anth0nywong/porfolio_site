...
import {DisplayAboutPage, DisplayContactPage, DisplayHomePage, DisplayProjectPage, DisplayServicesPage, DisplayProjectPage3} from '../controllers/controller.index.js';
...
router.get('/project3', DisplayProjectPage3);
/* GET Services page. */
