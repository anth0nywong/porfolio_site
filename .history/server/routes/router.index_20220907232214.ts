...
import {DisplayAboutPage, DisplayContactPage, DisplayHomePage, DisplayProjectPage, DisplayServicesPage, DisplayProjectPage6} from '../controllers/controller.index.js';
...
router.get('/project6', DisplayProjectPage6);
/* GET Services page. */
