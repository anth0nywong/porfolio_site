...
export function DisplayProjectPage3(req : express.Request, res: express.Response, next: express.NextFunction) 
{
  res.render('index', { title: 'My projects', page: 'project3', displayName:UserDisplayName(req)});
}
